<%-- 
    Document   : header
    Created on : 27 Mar, 2021, 3:34:08 PM
    Author     : hp
--%>
...
<html>
    ...
    <body style=" background-color: lavender;">
        ...
        <div class="nav nav-pills" style=" background-color: ivory; height: fit-content;">
            <p>

            </p>
            <div class="row" style=" width: 100rem;">
                <div class="col-md-8">
                    <h1 class="nav-item text-secondary" style=" margin-left: 20px;">Vacancy of Bed in Hospital and Quarantine Center</h1>
                </div>
                <div class="col-md-4">
                    <div style="float: right;">
                        <div class="row nav-justified" style="width: 300px; margin-top: 5px;">
                            <div class="col">
                                <div class="col"><%=name%><br/>[User]</div>
                            </div>
                            <div class="col">
                                <a class="btn btn-primary rounded-rect" href="logout.jsp"><i class="fas fa-sign-out-alt"></i> Sign Out </a>
                            </div>
                        </div>
                    </div>
                </div>
		...
		<div class="card" style=" background: none;">
		    <div class="card-body">
		        <ul class="nav justify-content-center">
		            ...
		            <li class="nav-item">
		                <a class="nav-link" href="covid_hosp.jsp">Covid Hospitals</a>
		            </li>
		            <li class="nav-item">
		                <a class="nav-link" href="qc.jsp">Quarantine Centers</a>
		            </li>
		        </ul>
		    </div>
		</div>
